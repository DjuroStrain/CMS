	...
	<div class="blog-item-wrap">
		<div class="post-inner-content">
			...
			<div class="entry-summary">
				<?php the_excerpt(); ?>
				<p><a class="btn btn-default read-more" href="<?php the_permalink(); ?>"><?php esc_html_e( 'Vidi više', 'activello' ); ?></a></p>
			</div><!-- .entry-summary -->
			<?php else : ?>
			...
			?>
				...
				<?php if ( ! post_password_required() && ( comments_open() || '0' != get_comments_number() ) ) : ?>
					<div class="entry-footer">
						<span class="comments-link"><?php comments_popup_link( esc_html__( 'Nema komentara', 'activello' ), esc_html__( '1 Comment', 'activello' ), esc_html__( '% Comments', 'activello' ) ); ?></span>
					</div><!-- .entry-footer -->
				<?php endif; ?>
			</div><!-- .entry-content -->
			<?php endif; ?>
