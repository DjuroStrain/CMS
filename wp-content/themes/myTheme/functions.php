 ...
 *
 * @package duroBelacicTheme
 */

/**
 * Postavi širinu sadržaja s obzirom na dizajn
 */
...
if ( ! function_exists( 'durobelacicTheme_main_content_bootstrap_classes' ) ) :
	/**
 * Add Bootstrap classes to the main-content-area wrapper.
 */
	function durobelacicTheme_main_content_bootstrap_classes() {
		if ( is_page_template( 'page-fullwidth.php' ) ) {
...
if ( ! function_exists( 'activello_header_search_filter' ) ) {
	function activello_header_search_filter( $form ) {
		$form = '<form action="' . esc_url( home_url( '/' ) ) . '" method="get"><input type="text" name="s" value="' . get_search_query() . '" placeholder="' . esc_attr_x( 'Traži', 'search placeholder', 'activello' ) . '"><button type="submit" class="header-search-icon" name="submit" id="searchsubmit" value="' . esc_attr_x( 'Search', 'submit button', 'activello' ) . '"><i class="fa fa-search"></i></button></form>';
		return $form;
	}
}
