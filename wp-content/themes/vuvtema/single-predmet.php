<?php 
    ...
    if ( have_posts() )
    {
        while ( have_posts() )
        {
            ...
            $satiPredavanja = get_post_meta($post->ID,'predmet_sati_predavanja',true);
            $satiLV = get_post_meta($post->ID,'predmet_sati_lv_vjezbi',true);
            $satiKV = get_post_meta($post->ID,'predmet_sati_kv',true);
    ...
    <div class="container">
        ...
        <div class="col-lg-8 col-md-10 mx-auto">
            ...
            <h3> ECTS: '. $ects.'</h3>
            <h3> Predavanja: '. $satiPredavanja.'</h3>
            <h3> Labaratorijske vježbe: '. $satiLV.'</h3>
            <h3> Konstrukcijske vježbe: '. $satiKV.'</h3>
